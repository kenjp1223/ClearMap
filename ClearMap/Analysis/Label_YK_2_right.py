...
Notes:      
    - The annotation file is assumed to be in './Data/Annotation/annotation_25.tif'
...
DefaultLabeledImageFile = os.path.join(ClearMapPath, '/home/thegoldenlab/clearmap_ressources_mouse_brain/ClearMap_ressources/Regions_annotations/Kim_ref_adult_FP-label_v2.0_right_RH.tif');
...
DefaultAnnotationFile   = os.path.join(ClearMapPath, 'Data/atlas_info_KimRef_FPbasedLabel_v2.7.csv');
...
def countPointsInRegions(points, labeledImage = DefaultLabeledImageFile, intensities = None, intensityRow = 0, level= None, allIds = True, sort = True, returnIds = True, returnCounts = True, collapse = None):
    global Label;
