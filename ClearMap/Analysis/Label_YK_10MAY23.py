...
DefaultLabeledImageFile = os.path.join(ClearMapPath, '/home/thegoldenlab/clearmap_ressources_mouse_brain/ClearMap_ressources/Regions_annotations/Kim_ref_adult_FP-label_v3.0.nrrd');
...
DefaultAnnotationFile   = os.path.join(ClearMapPath, 'Data/atlas_info_KimRef_FPbasedLabel_v3.0.csv');
