# -*- coding: utf-8 -*-
"""
Label and annotation info from Allen Institute CCFv3
...
DefaultLabeledImageFile = os.path.join(ClearMapPath, '/home/thegoldenlab/clearmap_ressources_mouse_brain/ClearMap_ressources/Regions_annotations/P56_CCFv3_Annotations_onLSFMtemplate_10um_LSP_16bit');
...
DefaultAnnotationFile   = os.path.join(ClearMapPath, 'Data/Label_info_pre-beta_release.csv');
...
def countPointsInRegions(points, labeledImage = DefaultLabeledImageFile, intensities = None, intensityRow = 0, level= None, allIds = True, sort = True, returnIds = True, returnCounts = False, collapse = None):
    global Label;
