...
DefaultLabeledImageFile = os.path.join(ClearMapPath, '/home/thegoldenlab/clearmap_ressources_mouse_brain/ClearMap_ressources/Regions_annotations/Kim_ref_adult_FP-label_v2.0.tif');
